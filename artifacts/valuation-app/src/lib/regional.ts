...
type LocaleBucket = {
  ...
  inspection: string;
  fuelOptions: string[];
  /** Local word for luggage area of a passenger car when writing listing copy */
  cargoAreaWord: string;
  /** Typical word pair for divided high-speed roads in casual seller copy */
  highwayWordPair: string;
};
...
const BUCKETS: Record<Locale, LocaleBucket> = {
  us: {
    ...
    fuelOptions: ["Gas", "Diesel", "Hybrid", "Plug-in Hybrid", "Electric"],
    cargoAreaWord: "trunk",
    highwayWordPair: "highway / freeway",
  },
  ca: {
    fuel: "gas",
    distance: "km",
    area: "sqft",
    carrierLock: "Carrier",
    inspection: "Provincial safety inspection",
    fuelOptions: ["Gas", "Diesel", "Hybrid", "Plug-in Hybrid", "Electric"],
    cargoAreaWord: "trunk",
    highwayWordPair: "highway",
  },
  uk: {
    fuel: "petrol",
    distance: "miles",
    area: "sqft",
    carrierLock: "Network",
    inspection: "MOT certificate",
    fuelOptions: ["Petrol", "Diesel", "Hybrid", "Plug-in Hybrid", "Electric"],
    cargoAreaWord: "boot",
    highwayWordPair: "motorway",
  },
  au: {
    fuel: "petrol",
    distance: "km",
    area: "sqm",
    carrierLock: "Network",
    inspection: "Roadworthy Certificate (RWC)",
    fuelOptions: ["Petrol", "Diesel", "Hybrid", "Plug-in Hybrid", "Electric", "LPG"],
    cargoAreaWord: "boot",
    highwayWordPair: "motorway / freeway",
  },
  nz: {
    fuel: "petrol",
    distance: "km",
    area: "sqm",
    carrierLock: "Network",
    inspection: "Warrant of Fitness (WOF)",
    fuelOptions: ["Petrol", "Diesel", "Hybrid", "Plug-in Hybrid", "Electric"],
    cargoAreaWord: "boot",
    highwayWordPair: "motorway / highway",
  },
  "eu-de": {
    fuel: "petrol",
    distance: "km",
    area: "sqm",
    carrierLock: "Network",
    inspection: "TÜV Hauptuntersuchung (HU)",
    fuelOptions: ["Benzin (Petrol)", "Diesel", "Hybrid", "Plug-in Hybrid", "Elektro", "LPG / Autogas"],
    cargoAreaWord: "boot",
    highwayWordPair: "Autobahn / motorway wording in English listings",
  },
  "eu-fr": {
    fuel: "petrol",
    distance: "km",
    ...
    fuelOptions: ["Essence (Petrol)", "Diesel", "Hybride", "Hybride rechargeable", "Électrique", "GPL"],
    cargoAreaWord: "boot",
    highwayWordPair: "motorway (autoroute in French copy if you pivot languages)",
  },
  "eu-it": {
    fuel: "petrol",
    distance: "km",
    area: "sqm",
    carrierLock: "Network",
    inspection: "Revisione auto",
    fuelOptions: ["Benzina (Petrol)", "Diesel", "Ibrido", "Plug-in Hybrid", "Elettrico", "GPL"],
    cargoAreaWord: "boot",
    highwayWordPair: "motorway (autostrada locally)",
  },
  "eu-es": {
    fuel: "petrol",
    distance: "km",
    ...
    fuelOptions: ["Gasolina (Petrol)", "Diésel", "Híbrido", "Híbrido enchufable", "Eléctrico", "GLP"],
    cargoAreaWord: "boot",
    highwayWordPair: "motorway (autopista locally)",
  },
  eu: {
    fuel: "petrol",
    distance: "km",
    area: "sqm",
    carrierLock: "Network",
    inspection: "Periodic vehicle inspection",
    fuelOptions: ["Petrol", "Diesel", "Hybrid", "Plug-in Hybrid", "Electric", "LPG"],
    cargoAreaWord: "boot",
    highwayWordPair: "motorway / highway wording",
  },
  ch: {
    fuel: "petrol",
    distance: "km",
    area: "sqm",
    carrierLock: "Network",
    inspection: "Motorfahrzeugkontrolle (MFK)",
    fuelOptions: ["Petrol", "Diesel", "Hybrid", "Plug-in Hybrid", "Electric"],
    cargoAreaWord: "boot",
    highwayWordPair: "motorway",
  },
  jp: {
    ...
    fuelOptions: ["Petrol", "Diesel", "Hybrid", "Plug-in Hybrid", "Electric"],
    cargoAreaWord: "trunk",
    highwayWordPair: "expressway / highway",
  },
  "intl-metric": {
    fuel: "petrol",
    distance: "km",
