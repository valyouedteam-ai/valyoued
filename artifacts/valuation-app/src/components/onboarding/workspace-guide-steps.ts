  ...
  const steps: WorkspaceGuideStep[] = [
    {
      ...
      body: "Workspaces keep ledgers separate, and navigation tabs always respect the workspace you have active. This short tour points at the controls you will use most.",
    },
    {
      ...
      body: isMobile
        ? "Portfolio, Valuate, Recent, Inheritance, and Insights open from the menu. When you valuate, pick portfolio workspace on the Region step so the asset lands on the right ledger."
    ...
    },
    {
      ...
      body: "When you have more than one ledger, pick it here. Inheritance workspaces use violet styling so it is obvious which ledger you are in.",
      interactive: true,
      skipIfMissing: true,
      placement: "bottom",
    },
    {
      ...
      body: "Estates, heirs, and heirlooms stay on a separate inheritance ledger. Open this hub before valuing items that should not mix with your primary holdings.",
      interactive: true,
      skipIfMissing: true,
      placement: "bottom",
    },
    {
      ...
      body: "Start here when you add an item. On the Region step, pick portfolio workspace so the asset lands on the ledger you intend.",
      interactive: true,
      skipIfMissing: true,
      placement: "bottom",
    },
