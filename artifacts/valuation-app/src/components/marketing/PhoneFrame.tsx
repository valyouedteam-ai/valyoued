  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "pointer-events-none absolute left-1/2 z-20 -translate-x-1/2 rounded-full bg-black",
        ...
        <div
          className={cn(
            "overflow-hidden bg-[hsl(222,28%,11%)]",
            compact ? "mx-1.5 mb-1.5 mt-8 rounded-[1.5rem]" : "mx-2 mb-2 mt-10 rounded-[2rem]",
          )}
        >
          {children}
        </div>
